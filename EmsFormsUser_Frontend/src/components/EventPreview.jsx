...
const EventPreview = ({ formData: globalFormData, setFormData: setGlobalFormData }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.secretary1.department) newErrors['secretary1.department'] = 'Secretary 1 department is required';
    ...
    if (!formData.secretary2.department) newErrors['secretary2.department'] = 'Secretary 2 department is required';
    ...
    if (!formData.convenor1.department) newErrors['convenor1.department'] = 'Convenor 1 department is required';
    ...
    if (!formData.convenor2.department) newErrors['convenor2.department'] = 'Convenor 2 department is required';
    ...
    if (!formData.volunteer1.department) newErrors['volunteer1.department'] = 'Volunteer 1 department is required';
    ...
    if (!formData.volunteer2.department) newErrors['volunteer2.department'] = 'Volunteer 2 department is required';
    ...
    className={errors['secretary1.mobile'] ? 'error' : ''}
              ...
              <FormGroup>
                ...
                <Select
                  ...
                  className={errors['secretary1.department'] ? 'error' : ''}
                >
                  <option value="">Select department...</option>
                  {departments.map(dept => <option key={dept} value={dept}>{dept}</option>)}
                </Select>
                {errors['secretary1.department'] && <ErrorMessage>{errors['secretary1.department']}</ErrorMessage>}
              </FormGroup>
              <FormGroup>
                <Label>Year</Label>
                <Select
            ...
            <PersonCard>
              ...
              <FormGroup>
                ...
                <Select
                  ...
                  className={errors['secretary2.department'] ? 'error' : ''}
                >
                  <option value="">Select department...</option>
                  {departments.map(dept => <option key={dept} value={dept}>{dept}</option>)}
                </Select>
                {errors['secretary2.department'] && <ErrorMessage>{errors['secretary2.department']}</ErrorMessage>}
              </FormGroup>
              <FormGroup>
                <Label>Year</Label>
                <Select
            ...
            <PersonCard>
              ...
              <FormGroup>
                ...
                <Select
                  ...
                  className={errors['convenor1.department'] ? 'error' : ''}
                >
                  <option value="">Select department...</option>
                  {departments.map(dept => <option key={dept} value={dept}>{dept}</option>)}
                </Select>
                {errors['convenor1.department'] && <ErrorMessage>{errors['convenor1.department']}</ErrorMessage>}
              </FormGroup>
              <FormGroup>
                <Label>Year</Label>
                <Select
            ...
            <PersonCard>
              ...
              <FormGroup>
                ...
                <Select
                  ...
                  className={errors['convenor2.department'] ? 'error' : ''}
                >
                  <option value="">Select department...</option>
                  {departments.map(dept => <option key={dept} value={dept}>{dept}</option>)}
                </Select>
                {errors['convenor2.department'] && <ErrorMessage>{errors['convenor2.department']}</ErrorMessage>}
              </FormGroup>
              <FormGroup>
                <Label>Year</Label>
                <Select
            ...
            <PersonCard>
              ...
              <FormGroup>
                ...
                <Select
                  ...
                  className={errors['volunteer1.department'] ? 'error' : ''}
                >
                  <option value="">Select department...</option>
                  {departments.map(dept => <option key={dept} value={dept}>{dept}</option>)}
                </Select>
                {errors['volunteer1.department'] && <ErrorMessage>{errors['volunteer1.department']}</ErrorMessage>}
              </FormGroup>
              <FormGroup>
                <Label>Year</Label>
                <Select
            ...
            <PersonCard>
              ...
              <FormGroup>
                ...
                <Select
                  ...
                  className={errors['volunteer2.department'] ? 'error' : ''}
                >
                  <option value="">Select department...</option>
                  {departments.map(dept => <option key={dept} value={dept}>{dept}</option>)}
                </Select>
                {errors['volunteer2.department'] && <ErrorMessage>{errors['volunteer2.department']}</ErrorMessage>}
              </FormGroup>
              <FormGroup>
                <Label>Year</Label>
                <Select
